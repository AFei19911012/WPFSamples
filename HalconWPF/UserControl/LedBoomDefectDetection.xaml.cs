...
{
    /// <summary>
    /// LedBoomDefectDetection.xaml 的交互逻辑
    /// </summary>
    public partial class LedBoomDefectDetection
    {
        public LedBoomDefectDetection()
        {
            InitializeComponent();
        }
        ...
        {
            HOperatorSet.ReadImage(out HObject ho_Image, @"D:\MyPrograms\DataSet\halcon\LED.tif");
            // 动态阈值
