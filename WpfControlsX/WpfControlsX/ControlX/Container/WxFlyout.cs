...
namespace WpfControlsX.ControlX
{
    ...
    public class WxFlyout : FrameworkElement
    {
        ...
        static WxFlyout()
        {
            DataContextProperty.OverrideMetadata(typeof(WxFlyout), new FrameworkPropertyMetadata(DataContextPropertyChanged));
        }
        ...
        {
            ((WxFlyout)d).OnDataContextPropertyChanged(e);
        }
        ...
        public static readonly RoutedEvent OpenedEvent =
            EventManager.RegisterRoutedEvent("Opened", RoutingStrategy.Bubble,
                typeof(RoutedEventHandler), typeof(WxFlyout));
        ...
        public static readonly DependencyProperty IsOpenProperty = DependencyProperty.Register(
            nameof(IsOpen), typeof(bool), typeof(WxFlyout), new FrameworkPropertyMetadata(ValueBoxes.FalseBox, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, OnIsOpenChanged));

        private static void OnIsOpenChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            WxFlyout ctl = (WxFlyout)d;
        ...
        public static readonly DependencyProperty MaskCanCloseProperty = DependencyProperty.Register(
            nameof(MaskCanClose), typeof(bool), typeof(WxFlyout), new PropertyMetadata(ValueBoxes.TrueBox));
        ...
        public static readonly DependencyProperty ShowMaskProperty = DependencyProperty.Register(
            nameof(ShowMask), typeof(bool), typeof(WxFlyout), new PropertyMetadata(ValueBoxes.TrueBox));
        ...
        public static readonly DependencyProperty DockProperty = DependencyProperty.Register(
            nameof(Dock), typeof(Dock), typeof(WxFlyout), new PropertyMetadata(default(Dock)));
        ...
        public static readonly DependencyProperty ShowModeProperty = DependencyProperty.Register(
            nameof(ShowMode), typeof(FlyoutShowMode), typeof(WxFlyout), new PropertyMetadata(default(FlyoutShowMode)));
        ...
        public static readonly DependencyProperty MaskBrushProperty = DependencyProperty.Register(
            nameof(MaskBrush), typeof(Brush), typeof(WxFlyout), new PropertyMetadata(default(Brush)));
        ...
        public static readonly DependencyProperty ContentProperty = DependencyProperty.Register(
            nameof(Content), typeof(object), typeof(WxFlyout), new PropertyMetadata(default(object)));
        ...
        private void CreateContainer()
        {
            ...
            WxSimplePanel panel = new WxSimplePanel
            {
                ClipToBounds = true
            };
            ...
            _ = panel.Children.Add(_animationControl);
        ...
        private void OnIsOpenChanged(bool isOpen)
        {
            ...
            FlyoutContainer parent = VisualHelper.GetParent<FlyoutContainer>(this);
            if (parent != null)
            {
            ...
            if (isOpen)
            {
                if (_maskElement != null)
                {
                    DoubleAnimation maskAnimation = AnimationHelper.CreateAnimation(1);
                ...
                DoubleAnimation drawerAnimation = AnimationHelper.CreateAnimation(0);
            ...
            else
            {
                if (_maskElement != null)
                {
                    DoubleAnimation maskAnimation = AnimationHelper.CreateAnimation(0);
                    Storyboard.SetTarget(maskAnimation, _maskElement);
                    Storyboard.SetTargetProperty(maskAnimation, new PropertyPath(OpacityProperty.Name));
                    _storyboard.Children.Add(maskAnimation);
                }

                DoubleAnimation drawerAnimation = AnimationHelper.CreateAnimation(_animationLength);
                Storyboard.SetTarget(drawerAnimation, _animationControl);
                Storyboard.SetTargetProperty(drawerAnimation, new PropertyPath(_animationPropertyName));
                _storyboard.Children.Add(drawerAnimation);
            }
        ...
        private void ShowByPush(bool isOpen)
        {
            ...
            DoubleAnimation animation = isOpen
        ...
        private void ShowByPress(bool isOpen)
        {
            ...
            DoubleAnimation animationX = isOpen
            ...
            DoubleAnimation animationY = isOpen
                ? AnimationHelper.CreateAnimation(.9)
                : AnimationHelper.CreateAnimation(1);
