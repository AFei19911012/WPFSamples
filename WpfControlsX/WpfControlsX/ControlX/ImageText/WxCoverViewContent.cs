...
namespace WpfControlsX.ControlX
{
    ...
    public class WxCoverViewContent : ContentControl
    {
        ...
        internal static readonly DependencyProperty ManualHeightProperty = DependencyProperty.Register(
            nameof(ManualHeight), typeof(double), typeof(WxCoverViewContent), new PropertyMetadata(ValueBoxes.Double0Box), ValidateHelper.IsInRangeOfPosDoubleIncludeZero);
        ...
        public static readonly DependencyProperty ContentHeightProperty = DependencyProperty.Register(
            nameof(ContentHeight), typeof(double), typeof(WxCoverViewContent), new PropertyMetadata(ValueBoxes.Double300Box),
        ...
        private void OpenSwitch(bool isOpen)
        {
            ...
            System.Windows.Media.Animation.DoubleAnimation animation = AnimationHelper.CreateAnimation(isOpen ? ManualHeight > 0 ? ManualHeight : ContentHeight : 0);
