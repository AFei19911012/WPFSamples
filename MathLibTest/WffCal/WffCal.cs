...
namespace MathLibTest
{
    public static class WffCal
    {
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)] public static extern void InvSaturation(double DTma1, double DTma2, double DTo1, double DTo2, double DTw1, double DTw2, double DENma, double DENo, double DENw, double n, double m, double Rw, double CNLma, double CNLo, double CNLw, double DTC, double DTS, double phi, double DENb, double CNL, double a, double b, double Rt1, double Rt2, double Rt3, double Swo, double lambda, ref double Sw1, ref double Sw2, ref double Sw3);
        #endregion
