...
namespace Wpf_Base.HalconWpf.Views
{
    ...
    /// Created Time: 22/09/20 17:49:36
    /// Description :
    /// ----------------------------------------------------------------
    /// Version      Modified Time              Modified By                               Modified Content
    /// V1.0.0.0     22/09/20 17:49:36    CoderMan/CoderdMan1012         首次编写         
    ///
    public class FindScaledShapeModelVM : ViewModelBase
    {
        ...
        private double numMatchScale = 0;
        public double NumMatchScale
        {
            get => numMatchScale;
            set => Set(ref numMatchScale, value);
        }
